...
class Plant(pygame.sprite.Sprite):
    def __init__(self, plant_type, groups, soil, check_watered):
        ...
        self.frames = import_folder(f'G:/Meu Drive/Pygame/ZeldaGame/graphics/fruit/{plant_type}')
        self.soil = soil
...
class SoilLayer:
    def __init__(self, all_sprites, collision_sprites):
        ...
        # graphics
        self.soil_surfs = import_folder_dict('G:/Meu Drive/Pygame/ZeldaGame/graphics/soil/')
        self.water_surfs = import_folder('G:/Meu Drive/Pygame/ZeldaGame/graphics/soil_water/')
        
        self.create_soil_grid()
        self.create_hit_rects()
        
    def create_soil_grid(self):
        ground = pygame.image.load('G:/Meu Drive/Pygame/ZeldaGame/graphics/world/ground.png')
        h_tiles, v_tiles = ground.get_width() // TILE_SIZE, ground.get_height() // TILE_SIZE
        
        self.grid = [[[] for col in range(h_tiles)] for row in range(v_tiles)]
        for x, y, _ in load_pygame('G:/Meu Drive/Pygame/ZeldaGame/data/map.tmx').get_layer_by_name('Farmable').tiles():
